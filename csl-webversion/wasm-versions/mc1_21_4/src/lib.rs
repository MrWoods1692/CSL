// Minecraft 1.21.4 WASM Module
// This is the entry point for the 1.21.4 version

use wasm_bindgen::prelude::*;
use csl_wasm_core::GameEngine;

#[wasm_bindgen]
pub struct Mc1214Engine {
    engine: GameEngine,
}
...
impl Mc1214Engine {
    ...
    pub fn new() -> Result<Mc1214Engine, JsValue> {
        Ok(Mc1214Engine {
            engine: GameEngine::new("1.21.4")?,
        })
    }
    ...
    pub fn get_player_position(&self) -> String {
        self.engine.get_player_position()
    }
    ...
    pub fn get_mod_count(&self) -> usize {
        self.engine.get_mod_count()
    }

    pub fn get_mods(&self) -> String {
        self.engine.get_mods()
    }
