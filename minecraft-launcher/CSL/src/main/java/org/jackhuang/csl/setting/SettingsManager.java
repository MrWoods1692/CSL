...
public final class SettingsManager {
    ...
    private static final Path LOCAL_CONFIG_FILES_DIRECTORY = Metadata.CSL_LOCAL_HOME.resolve("config");

    /// The local directory storing per-workspace state files.
    private static final Path LOCAL_STATE_DIRECTORY = Metadata.CSL_LOCAL_HOME.resolve("state");

    /// The local directory storing per-workspace cache files.
    private static final Path LOCAL_CACHE_DIRECTORY = Metadata.CSL_LOCAL_HOME.resolve("cache");

    /// The local directory storing per-workspace private data files.
    private static final Path LOCAL_PRIVATE_DIRECTORY = Metadata.CSL_LOCAL_HOME.resolve("private");

    /// The user directory storing shared configuration files.
    private static final Path USER_CONFIG_FILES_DIRECTORY = Metadata.CSL_USER_HOME.resolve("config");

    /// The user directory storing shared state files.
    private static final Path USER_STATE_DIRECTORY = Metadata.CSL_USER_HOME.resolve("state");

    /// The user directory storing shared private data files.
    private static final Path USER_PRIVATE_DIRECTORY = Metadata.CSL_USER_HOME.resolve("private");

    /// The legacy settings path used as a migration input.
    private static final Path LEGACY_SETTINGS_LOCATION = Metadata.CSL_LOCAL_HOME.resolve("settings.json");
    ...
    public static Path localConfigDirectory() {
        return Metadata.CSL_LOCAL_HOME;
    }
    ...
    public static void init() throws IOException {
        ...
        if (Files.exists(Metadata.CSL_LOCAL_HOME)) {
            checkWritable(Metadata.CSL_LOCAL_HOME);
        }
    ...
    private static void checkLocalConfigOwner() {
        checkOwner(Metadata.CSL_LOCAL_HOME);
