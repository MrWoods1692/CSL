...
/// CSL directory or the user CSL directory.
///
/// @author Glavo
...
public final class GameDirectories extends ObservableSetting implements JsonSchemaSetting {
    ...
    /// Whether this store represents `CSL_USER_HOME/config/user-game-directories.json`.
    ...
    /// Sets whether this store represents `CSL_USER_HOME/config/user-game-directories.json`.
    void setUserFile(boolean userFile) {
        this.userFile = userFile;
    }

    /// Returns whether this store represents `CSL_USER_HOME/config/user-game-directories.json`.
    boolean isUserFile() {
        return userFile;
    }
