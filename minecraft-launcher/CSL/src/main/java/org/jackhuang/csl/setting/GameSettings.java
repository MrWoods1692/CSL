...
import org.jackhuang.csl.setting.property.InheritableProperty;
import org.jackhuang.csl.setting.property.SettingProperty;
import org.jackhuang.csl.setting.property.SimpleInheritableProperty;
import org.jackhuang.csl.setting.property.SimpleSettingProperty;
import org.jackhuang.csl.util.DigestUtils;
...
public sealed abstract class GameSettings extends ObservableSetting {
    ...
    /// Reference to a Java runtime selected from CSL's detected Java list.
    ///
    ...
    /// If `true`, CSL will not use default JVM arguments.
    ...
    /// If `true`, CSL will not use the default optimizing JVM options.
    ...
    /// If `true`, CSL does not check JVM validity.
    ...
    /// If `true`, CSL does not check game completeness.
    ...
    /// If `true`, CSL will automatically adjust memory allocation.
    ...
    /// Property name for allowing CSL to modify the game with Java agents.
    public static final String PROPERTY_ALLOW_AUTO_AGENT = "allowAutoAgent";

    /// If `true`, CSL may attach Java agents to improve the game experience.
    ...
    /// If `true`, CSL will not generate game options automatically.
    ...
    /// If `true`, CSL does not patch native libraries.
    ...
    /// If `true`, CSL leaves native library management to the user.
    ...
    /// If `true`, CSL will use native GLFW.
    ...
    /// If `true`, CSL will use native OpenAL.
