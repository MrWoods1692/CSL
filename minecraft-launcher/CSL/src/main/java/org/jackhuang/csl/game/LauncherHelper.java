...
import org.jackhuang.csl.Launcher;
import org.jackhuang.csl.auth.*;
import org.jackhuang.csl.auth.offline.OfflineAccount;
...
import org.jackhuang.csl.download.MaintainTask;
import org.jackhuang.csl.download.game.*;
import org.jackhuang.csl.java.JavaManager;
import org.jackhuang.csl.java.JavaRuntime;
import org.jackhuang.csl.launch.*;
import org.jackhuang.csl.modpack.ModpackCompletionException;
...
import org.jackhuang.csl.setting.LauncherVisibility;
import org.jackhuang.csl.task.*;
...
import org.jackhuang.csl.ui.construct.TaskExecutorDialogPane;
import org.jackhuang.csl.util.*;
import org.jackhuang.csl.util.i18n.I18n;
import org.jackhuang.csl.util.io.FileUtils;
import org.jackhuang.csl.util.io.ResponseCodeException;
...
import static org.jackhuang.csl.util.logging.Logger.TIME_FORMATTER;
import static org.jackhuang.csl.util.platform.Platform.SYSTEM_PLATFORM;
...
public final class LauncherHelper {
    ...
    public LauncherHelper(CSLGameRepository repository, Account account, GameInstanceID selectedInstanceId) {
    ...
    private void launch0() {
        // https://github.com/MrWoods1692/CSL/pull/4121
        ...
        TaskExecutor executor = checkGameState(repository, setting, version.get())
                ...
                .thenComposeAsync(authInfo -> Task.supplyAsync(() -> {
                    ...
                    return new CSLGameLauncher(
                            ...
                            launcherVisibility == LauncherVisibility.CLOSE
                                    ...
                                    : new CSLProcessListener(repository, version.get(), authInfo, launchOptions, launchingLatch, gameVersion.isPresent())
                    );
                ...
                .withStagesHints(
                        ...
                        new Task.StagesHint("launch.state.dependencies", List.of("csl.install.assets", "csl.install.libraries", "csl.modpack.download")),
    ...
    private static Task<JavaRuntime> checkGameState(CSLGameRepository repository, GameSettings.Effective setting, GameInstanceManifest manifest) {
    ...
    private static CompletableFuture<JavaRuntime> downloadJava(GameJavaVersion javaVersion, CSLGameRepository repository) {
        CompletableFuture<JavaRuntime> future = new CompletableFuture<>();
     ...
     * Guarantee that one [JavaProcess], one [CSLProcessListener].
     * Because every time we launched a game, we generates a new [CSLProcessListener]
     */
    private final class CSLProcessListener implements ProcessListener {
