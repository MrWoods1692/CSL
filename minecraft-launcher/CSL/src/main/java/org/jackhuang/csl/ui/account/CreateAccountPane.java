...
import org.jackhuang.csl.auth.AccountFactory;
import org.jackhuang.csl.auth.CharacterSelector;
import org.jackhuang.csl.auth.NoSelectedCharacterException;
...
import org.jackhuang.csl.auth.yggdrasil.GameProfile;
import org.jackhuang.csl.auth.yggdrasil.YggdrasilService;
import org.jackhuang.csl.game.TexturesLoader;
        ...
        public AccountDetailsInputPane(AccountFactory<?> factory, Runnable onAction) {
            ...
            if (factory.getLoginType().requiresUsername) {
                ...
                txtUsername.setValidators(
                        ...
                        new Validator(i18n("input.email"), username -> true));
