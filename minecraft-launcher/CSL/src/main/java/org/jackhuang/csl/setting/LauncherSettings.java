...
public final class LauncherSettings extends ObservableSetting implements JsonSchemaSetting {
    ...
    public static final ThemeReference DEFAULT_THEME_REFERENCE = new ThemeReference("csl.default", null);
    ...
    /// Whether CSL automatically selects the number of download threads.
