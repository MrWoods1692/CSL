...
import org.jackhuang.csl.addon.mod.LocalModFile;
...
import org.jackhuang.csl.util.Lazy;
...
import static org.jackhuang.csl.ui.FXUtils.ignoreEvent;
import static org.jackhuang.csl.ui.FXUtils.onEscPressed;
import static org.jackhuang.csl.ui.ToolbarListPageSkin.createToolbarButton2;
                            ...
                            FXUtils.runInFX(() -> {
                                ...
                                button.setOnAction(e -> {
                                    ...
                                    Controllers.navigate(new DownloadPage(
                                            repository instanceof CurseForgeRemoteAddonRepository ? CSLLocalizedDownloadListPage.ofCurseForgeMod(null, false) : CSLLocalizedDownloadListPage.ofModrinthMod(null, false),
                                            remoteAddon,
                                            new CSLGameRepository.InstanceReference(ModListPageSkin.this.getSkinnable().getRepository(), ModListPageSkin.this.getSkinnable().getInstanceId()),
                                            org.jackhuang.csl.ui.download.DownloadPage.FOR_MOD
                                    ));
                                });
