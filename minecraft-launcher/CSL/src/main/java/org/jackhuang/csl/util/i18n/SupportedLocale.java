...
import org.jackhuang.csl.util.i18n.translator.Translator;
...
public final class SupportedLocale {
    ...
    SupportedLocale() {
        ...
        String language = System.getenv("CSL_LANGUAGE");
    ...
    /// Used to represent the text display language of CSL.
    ///
    ...
    public String getDisplayName(SupportedLocale inLocale) {
        ...
        // Currently, CSL does not support any locales with regions or variants, so they are not handled for now
