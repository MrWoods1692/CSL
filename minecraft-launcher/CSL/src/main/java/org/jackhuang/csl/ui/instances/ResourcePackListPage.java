...
import org.jackhuang.csl.addon.LocalAddonFile;
...
import org.jackhuang.csl.addon.resourcepack.ResourcePackFile;
import org.jackhuang.csl.addon.resourcepack.ResourcePackManager;
...
import org.jackhuang.csl.ui.ListPageBase;
...
public final class ResourcePackListPage extends ListPageBase<ResourcePackListPage.ResourcePackInfoObject> implements GameInstancePage.GameInstanceLoadable {
    ...
    @Override
    public void loadInstance(CSLGameRepository repository, @Nullable GameInstanceID instanceId) {
                            ...
                            button.setOnAction(e -> {
                                ...
                                Controllers.navigate(new DownloadPage(
                                        repository instanceof CurseForgeRemoteAddonRepository
                                                ? CSLLocalizedDownloadListPage.ofCurseForgeResourcePack(null, false)
                                                : CSLLocalizedDownloadListPage.ofModrinthResourcePack(null, false),
                                        remoteAddon,
                                        new CSLGameRepository.InstanceReference(page.repository, page.instanceId),
                                        org.jackhuang.csl.ui.download.DownloadPage.FOR_RESOURCE_PACK
                                ));
                            });
