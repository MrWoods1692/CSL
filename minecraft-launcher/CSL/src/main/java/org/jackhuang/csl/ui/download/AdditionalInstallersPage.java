...
import org.jackhuang.csl.ui.InstallerItem;
...
import static org.jackhuang.csl.download.LibraryAnalyzer.LibraryType.MINECRAFT;
...
class AdditionalInstallersPage extends AbstractInstallersPage {
    ...
    protected final CSLGameRepository repository;
    protected final String gameVersion;
    protected final GameInstanceManifest manifest;

    public AdditionalInstallersPage(String gameVersion, GameInstanceManifest manifest, WizardController controller, CSLGameRepository repository, DownloadProvider downloadProvider) {
