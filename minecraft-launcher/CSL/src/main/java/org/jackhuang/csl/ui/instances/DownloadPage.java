...
import org.jackhuang.csl.addon.mod.ModLoaderType;
...
public class DownloadPage extends Control implements DecoratorPage {
    ...
    private final CSLGameRepository.InstanceReference instanceReference;
    ...
    public DownloadPage(DownloadListPage page, RemoteAddon addon, CSLGameRepository.InstanceReference instanceReference, @Nullable DownloadCallback callback) {
        this.page = page;
    ...
    public CSLGameRepository.InstanceReference getInstanceReference() {
            ...
            pane.getChildren().add(spinnerPane);
            {
                ...
                FXUtils.onChangeAndOperate(control.loaded, loaded -> {
                    ...
                    if (control.instanceReference.repository() != null && control.instanceReference.instanceId() != null) {
                        CSLGameRepository repository = control.instanceReference.repository();
    ...
    private static final class DependencyAddonItem extends LineButton {
        ...
        DependencyAddonItem(DownloadListPage page, RemoteAddon addon, CSLGameRepository.InstanceReference instanceReference) {
            this.addon = addon;
            ...
            DownloadCallback callback = switch (type) {
                case MOD -> org.jackhuang.csl.ui.download.DownloadPage.FOR_MOD;
                case RESOURCE_PACK -> org.jackhuang.csl.ui.download.DownloadPage.FOR_RESOURCE_PACK;
                case SHADER_PACK -> org.jackhuang.csl.ui.download.DownloadPage.FOR_SHADER;
    ...
    private static final class AddonItem extends StackPane {
        ...
        AddonItem(RemoteAddon mod, RemoteAddon.Version dataItem, DownloadPage selfPage) {
            ...
            // Workaround for https://github.com/MrWoods1692/CSL/issues/2129
    ...
    public interface DownloadCallback {
        void download(DownloadProvider downloadProvider, CSLGameRepository repository, @Nullable GameInstanceID instanceId, RemoteAddon addon, RemoteAddon.Version file);
    }
}
