...
public class AdvancedListItem extends Control {
    ...
    /**
     * Whether the item uses the compact vertical layout (icon above the title),
     * used by the collapsible sidebar. Other pages keep the default horizontal layout.
     */
    ...
    /**
     * Whether the title is shown. Only meaningful when {@link #compact} is true.
     */
