...
/**
 * A class that checks the integrity of CSL.
 *
 * @author yushijinhun
 */
public final class IntegrityChecker {
    ...
    public static final boolean DISABLE_SELF_INTEGRITY_CHECK = "true".equals(System.getProperty("csl.self_integrity_check.disable"));

    private static final String SIGNATURE_FILE = "META-INF/csl_signature";
    private static final String PUBLIC_KEY_FILE = "assets/csl_signature_publickey.der";
