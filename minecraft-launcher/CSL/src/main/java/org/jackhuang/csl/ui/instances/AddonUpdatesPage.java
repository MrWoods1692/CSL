...
import org.jackhuang.csl.addon.LocalAddonManager;
...
import org.jackhuang.csl.ui.construct.JFXCheckBoxTableCell;
import org.jackhuang.csl.ui.construct.MessageDialogPane;
import org.jackhuang.csl.ui.construct.PageCloseEvent;
...
import org.jackhuang.csl.util.io.CSVTable;
...
public class AddonUpdatesPage<F extends LocalAddonFile> extends BorderPane implements DecoratorPage {
    ...
    private void exportList() {
        Path path = Paths.get("csl-mod-update-list-" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH-mm-ss")) + ".csv").toAbsolutePath();
