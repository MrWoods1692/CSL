...
import org.jackhuang.csl.auth.microsoft.MicrosoftAccount;
import org.jackhuang.csl.auth.microsoft.MicrosoftAccountFactory;
import org.jackhuang.csl.auth.microsoft.MicrosoftService;
import org.jackhuang.csl.auth.offline.OfflineAccount;
import org.jackhuang.csl.auth.offline.OfflineAccountFactory;
import org.jackhuang.csl.auth.yggdrasil.RemoteAuthenticationException;
import org.jackhuang.csl.game.OAuthServer;
import org.jackhuang.csl.task.Schedulers;
import org.jackhuang.csl.util.gson.JsonUtils;
import org.jackhuang.csl.util.skin.InvalidSkinException;
...
import static org.jackhuang.csl.setting.SettingsManager.getAccountMetadataRecords;
import static org.jackhuang.csl.setting.SettingsManager.getUserAccountMetadataRecords;
import static org.jackhuang.csl.setting.SettingsManager.userSettings;
import static org.jackhuang.csl.ui.FXUtils.onInvalidating;
import static org.jackhuang.csl.util.Lang.immutableListOf;
...
public final class Accounts {
    ...
    public static final OfflineAccountFactory FACTORY_OFFLINE = new OfflineAccountFactory();
    ...
    public static final List<AccountFactory<?>> FACTORIES = immutableListOf(FACTORY_OFFLINE, FACTORY_MICROSOFT);
