 ...
 */
package org.jackhuang.csl.ui.game;
...
import org.jackhuang.csl.ui.MemoryStatusBar;
import org.jackhuang.csl.ui.WeakListenerHolder;
import org.jackhuang.csl.ui.construct.LineComponent;
import org.jackhuang.csl.ui.construct.LineInheritableToggleButton;
import org.jackhuang.csl.ui.construct.RadioChoiceList;
...
import org.jackhuang.csl.util.platform.hardware.PhysicalMemoryStatus;
...
import static org.jackhuang.csl.util.DataSizeUnit.GIGABYTES;
...
final class IndependentSettingBinder {
    ...
    private static void updateMemoryStatus(
        ...
        if (Boolean.TRUE.equals(autoMemory)) {
            memoryAllocated = CSLGameRepository.getAutoAllocatedMemory(memoryStatus.available());
