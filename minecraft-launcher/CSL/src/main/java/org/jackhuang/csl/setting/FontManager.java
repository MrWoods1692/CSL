...
public final class FontManager {
    ...
    private static final Lazy<Font> DEFAULT_FONT = new Lazy<>(() -> {
        ...
        font = tryLoadLocalizedFont(Metadata.CSL_LOCAL_HOME.resolve("font"));
        if (font != null)
            return font;

        font = tryLoadLocalizedFont(Metadata.CSL_USER_HOME.resolve("font"));
        if (font != null)
            return font;

        // Legacy

        font = tryLoadDefaultFont(Metadata.CSL_LOCAL_HOME);
        if (font != null)
            return font;
        ...
        font = tryLoadDefaultFont(Metadata.CSL_USER_HOME);
        if (font != null)
            return font;
