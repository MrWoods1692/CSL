...
import org.jackhuang.csl.ui.account.AccountListPage;
...
import org.jackhuang.csl.ui.decorator.DecoratorController;
...
import org.jackhuang.csl.util.i18n.SupportedLocale;
...
import static org.jackhuang.csl.setting.SettingsManager.userState;
...
public final class Controllers {
    ...
    public static void onHyperlinkAction(String href) {
        if (href.startsWith("csl://")) {
            switch (href) {
                case "csl://settings/feedback":
                    Controllers.getSettingsPage().showFeedback();
                    Controllers.navigate(Controllers.getSettingsPage());
                    break;
                case "csl://game/launch":
