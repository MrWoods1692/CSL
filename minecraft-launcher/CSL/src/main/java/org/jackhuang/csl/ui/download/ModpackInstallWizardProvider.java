...
import org.jackhuang.csl.game.ManuallyCreatedModpackException;
...
import org.jackhuang.csl.modpack.UnsupportedModpackException;
...
public final class ModpackInstallWizardProvider implements WizardProvider {
    ...
    public ModpackInstallWizardProvider(CSLGameRepository repository) {
        this(repository, null, null);
    }

    public ModpackInstallWizardProvider(CSLGameRepository repository, Path modpackFile) {
        this(repository, modpackFile, null);
    }

    public ModpackInstallWizardProvider(CSLGameRepository repository, GameInstanceID updateInstanceId) {
        this(repository, null, updateInstanceId);
    }

    public ModpackInstallWizardProvider(CSLGameRepository repository, Path modpackFile, GameInstanceID updateInstanceId) {
