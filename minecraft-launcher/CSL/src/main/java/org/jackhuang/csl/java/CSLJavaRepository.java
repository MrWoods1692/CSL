...
import org.jackhuang.csl.download.java.mojang.MojangJavaRemoteFiles;
 ...
 * @author Glavo
 */
public final class CSLJavaRepository implements JavaRepository {
    public static final String MOJANG_JAVA_PREFIX = "mojang-";

    private final Path root;

    public CSLJavaRepository(Path root) {
        this.root = root;
    }
