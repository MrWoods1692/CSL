...
import org.jackhuang.csl.ui.construct.LinePane;
import org.jackhuang.csl.ui.construct.LineTextPane;
...
public abstract class ModpackPage extends SpinnerPane implements WizardPage {
    ...
    public static final SettingsMap.Key<CSLGameRepository> REPOSITORY = new SettingsMap.Key<>("REPOSITORY");
