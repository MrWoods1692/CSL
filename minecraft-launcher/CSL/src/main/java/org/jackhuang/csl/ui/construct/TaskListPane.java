...
import org.jackhuang.csl.download.cleanroom.CleanroomInstallTask;
import org.jackhuang.csl.download.fabric.FabricAPIInstallTask;
import org.jackhuang.csl.download.fabric.FabricInstallTask;
import org.jackhuang.csl.download.forge.ForgeNewInstallTask;
import org.jackhuang.csl.download.forge.ForgeOldInstallTask;
import org.jackhuang.csl.download.game.GameAssetDownloadTask;
import org.jackhuang.csl.download.game.GameInstallTask;
import org.jackhuang.csl.download.java.mojang.MojangJavaDownloadTask;
import org.jackhuang.csl.download.legacyfabric.LegacyFabricInstallTask;
import org.jackhuang.csl.download.liteloader.LiteLoaderInstallTask;
import org.jackhuang.csl.download.neoforge.NeoForgeInstallTask;
import org.jackhuang.csl.download.neoforge.NeoForgeOldInstallTask;
import org.jackhuang.csl.download.optifine.OptiFineInstallTask;
import org.jackhuang.csl.download.quilt.QuiltAPIInstallTask;
import org.jackhuang.csl.download.quilt.QuiltInstallTask;
import org.jackhuang.csl.game.CSLModpackInstallTask;
import org.jackhuang.csl.java.JavaInstallTask;
...
import org.jackhuang.csl.modpack.curse.CurseCompletionTask;
import org.jackhuang.csl.modpack.curse.CurseInstallTask;
import org.jackhuang.csl.modpack.mcbbs.McbbsModpackCompletionTask;
import org.jackhuang.csl.modpack.mcbbs.McbbsModpackExportTask;
import org.jackhuang.csl.modpack.modrinth.ModrinthCompletionTask;
import org.jackhuang.csl.modpack.modrinth.ModrinthInstallTask;
import org.jackhuang.csl.modpack.modrinth.ModrinthModpackExportTask;
import org.jackhuang.csl.modpack.multimc.MultiMCModpackExportTask;
import org.jackhuang.csl.modpack.multimc.MultiMCModpackInstallTask;
import org.jackhuang.csl.modpack.server.ServerModpackCompletionTask;
import org.jackhuang.csl.modpack.server.ServerModpackExportTask;
import org.jackhuang.csl.modpack.server.ServerModpackLocalInstallTask;
...
import org.jackhuang.csl.util.FXThread;
...
import static org.jackhuang.csl.util.Lang.tryCast;
        ...
        executor.addTaskListener(new TaskListener() {
            ...
            public void onRunning(Task<?> task) {
                ...
                if (task instanceof GameAssetDownloadTask) {
                    ...
                    if (task.getInheritedStage() != null && task.getInheritedStage().startsWith("csl.install.game"))
                        return;
                ...
                } else if (task instanceof CSLModpackInstallTask) {
                    task.setName(i18n("modpack.installing.given", i18n("modpack.type.csl")));
    ...
    private static final class StageNode extends Node {
        ...
        private StageNode(String stage) {
            ...
            message = switch (stageKey) {
                case "csl.modpack" ->                  i18n("install.modpack");
                case "csl.modpack.download" ->         i18n("launch.state.modpack");
                case "csl.install.assets" ->           i18n("assets.download");
                case "csl.install.libraries" ->        i18n("libraries.download");
                case "csl.install.game" ->             i18n("install.installer.install", i18n("install.installer.game") + " " + stageValue);
                case "csl.install.forge" ->            i18n("install.installer.install", i18n("install.installer.forge") + " " + stageValue);
                case "csl.install.cleanroom" ->        i18n("install.installer.install", i18n("install.installer.cleanroom") + " " + stageValue);
                case "csl.install.neoforge" ->         i18n("install.installer.install", i18n("install.installer.neoforge") + " " + stageValue);
                case "csl.install.liteloader" ->       i18n("install.installer.install", i18n("install.installer.liteloader") + " " + stageValue);
                case "csl.install.optifine" ->         i18n("install.installer.install", i18n("install.installer.optifine") + " " + stageValue);
                case "csl.install.fabric" ->           i18n("install.installer.install", i18n("install.installer.fabric") + " " + stageValue);
                case "csl.install.fabric-api" ->       i18n("install.installer.install", i18n("install.installer.fabric-api") + " " + stageValue);
                case "csl.install.legacyfabric" ->     i18n("install.installer.install", i18n("install.installer.legacyfabric") + " " + stageValue);
                case "csl.install.legacyfabric-api" -> i18n("install.installer.install", i18n("install.installer.legacyfabric-api") + " " + stageValue);
                case "csl.install.quilt" ->            i18n("install.installer.install", i18n("install.installer.quilt") + " " + stageValue);
                case "csl.install.quilt-api" ->        i18n("install.installer.install", i18n("install.installer.quilt-api") + " " + stageValue);
