...
import org.jackhuang.csl.ui.WebPage;
import org.jackhuang.csl.ui.construct.MessageDialogPane;
import org.jackhuang.csl.ui.construct.RequiredValidator;
...
public final class LocalModpackPage extends ModpackPage {
    ...
    public LocalModpackPage(WizardController controller) {
        ...
        CSLGameRepository repository = controller.getSettings().get(ModpackPage.REPOSITORY);
        ...
        Task.supplyAsync(() -> CompressingUtils.findSuitableEncoding(selectedFile))
                ...
                .whenComplete(Schedulers.javafx(), (manifest, exception) -> {
                    if (exception instanceof ManuallyCreatedModpackException) {
                        ...
                        if (name == null) {
                            // trim: https://github.com/MrWoods1692/CSL/issues/962
