...
public class CSLCacheRepository extends DefaultCacheRepository {

    private final StringProperty directory = new SimpleStringProperty();

    public CSLCacheRepository() {
    ...
    public static final CSLCacheRepository REPOSITORY = new CSLCacheRepository();
}
