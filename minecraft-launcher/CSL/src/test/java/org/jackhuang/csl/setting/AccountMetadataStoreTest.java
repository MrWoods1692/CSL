...
public final class AccountMetadataStoreTest {
    ...
    private static Class<?> accountPrivateDataStoreType() throws ClassNotFoundException {
        return Class.forName("org.jackhuang.csl.setting.SettingsManager$AccountPrivateDataStore");
    }
    ...
    private static Class<?> accountPrivateDataUpdateType() throws ClassNotFoundException {
        return Class.forName("org.jackhuang.csl.setting.SettingsManager$AccountPrivateDataUpdate");
    }
    ...
    public void serializesPrivateDataAsProtectedPayload() {
        ...
        try {
            ...
            assertEquals(AccountPrivateData.CURRENT_SCHEMA.url(),
                    serialized.get(JsonSchema.PROPERTY_SCHEMA).getAsString());
            assertEquals("csl-obfuscated-v1", serialized.get("protection").getAsString());
