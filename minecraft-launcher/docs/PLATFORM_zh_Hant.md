...
* ✅️ 完整支援
  ...
  受到完整支援的平臺。CSL 會盡可能為此平臺提供支援。

* 🕰️ 有限支援

  這些平臺通常是老舊的遺留平臺。

  CSL 可以在這些平臺上運作，但部分功能可能無法使用。
...
* 🕰️ CSL 3.6（有限支援）
  ...
  我們透過 CSL 3.6 LTS 分支繼續為該平臺提供安全修補與錯誤修復，
  但此平臺上將無法獲得功能更新。

* /（不支援）

  CSL 尚未支援此平臺。我們未來可能會支援此平臺。
...
* 👌: 支援的平臺
  ...
  由 CSL 提供支援，經過測試可以正常執行，但可能比得到全面支援的平臺有更多問題。  
  不保證支援 Minecraft 1.6 以下的版本。  
  如果你遇到在得到全面支援的平臺上不存在的問題，可以向 CSL 回報。

* ❔: 低級別支援的平臺

  CSL 可以在這個平臺上執行，並且有一些基本的支援。但是，還不能正常地啟動遊戲。  
