...
* ✅️ 完整支持
  ...
  受到完整支持的平台。CSL 会尽可能为此平台提供支持。

* 🕰️ 有限支持

  这些平台通常是老旧的遗留平台。

  CSL 可以在这些平台上工作，但部分功能可能无法使用。
...
* 🕰️ CSL 3.6 (有限支持)
  ...
  我们通过 CSL 3.6 LTS 分支继续为该平台提供安全补丁和错误修复，
  但此平台上将无法接受到功能更新。

* / (不受支持)

  CSL 尚不支持此平台。我们可能会在未来支持此平台。
...
* 👌: 支持的平台
  ...
  由 CSL 提供支持，经过测试可以正常运行，但可能比得到全面支持的平台有更多问题。  
  不保证支持 Minecraft 1.6 以下的版本。  
  如果你遇到在得到全面支持的平台上不存在的问题，可以向 CSL 反馈。

* ❔: 低级别支持的平台

  CSL 可以在这个平台上运行，并且有一些基本的支持。但是，还不能正常地启动游戏。  
