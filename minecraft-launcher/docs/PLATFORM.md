  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <br>
        🕰️ <a href="https://github.com/MrWoods1692/CSL/releases?q=3.6">CSL 3.6</a> (Windows Vista)
        <br>
        🕰️ <a href="https://github.com/MrWoods1692/CSL/releases?q=3.6">CSL 3.6</a> (Windows Server 2003 ~ 2008) 
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        <br>
        🕰️ <a href="https://github.com/MrWoods1692/CSL/releases?q=3.6">CSL 3.6</a> (Windows XP/Vista)
      </td>
...
* ✅️ Fully supported
  ...
  Platforms that are fully supported. CSL will provide support for these platforms as much as possible.

* 🕰️ Limited support

  These platforms are usually legacy platforms.

  CSL can work on these platforms, but some features may not be available.

  We may drop some features for these platforms to reduce maintenance costs.

* 🕰️ CSL 3.6 (Limited support)

  The main branch of CSL no longer supports these platforms.

  We continue to provide security patches and bug fixes for these platforms through the CSL 3.6 LTS branch,
  but no feature updates will be available.

* / (Not supported)

  CSL does not support these platforms yet. We may support them in the future.
...
* 👌: Supported platforms.
  ...
  Support is provided by CSL, tested to work, but may have more problems than a fully supported platform.  
  Support for versions below Minecraft 1.6 is not guaranteed.  
  If you encounter a problem that does not exist on fully supported platforms, you can report it to CSL.

* ❔: Low-level supported platforms.

  CSL can run on this platform and has some basic support. However, launching the game directly is not yet available.  
