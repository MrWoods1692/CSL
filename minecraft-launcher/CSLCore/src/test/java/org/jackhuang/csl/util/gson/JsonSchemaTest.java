...
public final class JsonSchemaTest {
    ...
    /// Tests reading schema strings that are not CSL schema URLs.
    @Test
    ...
    public void checksCompatibility() {
        ...
        object.addProperty(JsonSchema.PROPERTY_SCHEMA, "csl.config/3.x");
        ...
        assertEquals("csl.config/3.x", unparseable.actual().url());
    ...
    private static String schemaUrl(String id, String version) {
        return "https://schemas.glavo.site/csl/" + id + "/" + version;
    }
}
