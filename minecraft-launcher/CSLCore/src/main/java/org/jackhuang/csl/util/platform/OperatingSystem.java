...
import org.jackhuang.csl.util.KeyValuePairUtils;
import org.jackhuang.csl.util.platform.windows.Kernel32;
...
public enum OperatingSystem {
    ...
    static {
        ...
        String cslNativeEncoding = System.getProperty("csl.native.encoding");
        Charset nativeCharset = Charset.defaultCharset();

        try {
            if (cslNativeEncoding != null) {
                nativeCharset = Charset.forName(cslNativeEncoding);
            } else {
