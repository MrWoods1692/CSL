...
public final class CleanroomVersionList extends VersionList<CleanroomRemoteVersion> {
    ...
    private static final String LOADER_LIST_URL = "https://csl.glavo.site/metadata/cleanroom/index.json";
    private static final String INSTALLER_URL = "https://csl.glavo.site/metadata/cleanroom/files/cleanroom-%s-installer.jar";
