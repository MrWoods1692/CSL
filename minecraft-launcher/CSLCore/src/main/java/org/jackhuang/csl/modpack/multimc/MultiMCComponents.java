...
public final class MultiMCComponents {
    ...
    static {
        ...
        // Check whether MultiMCComponents is 'org.jackhuang.csl.mod.multimc.MultiMCComponents'.
        ...
        if (new String(
            ...
            INSTALLER_PROFILE.put("Implementation", "Probably vanilla. Class location is not modified (org.jackhuang.csl.mod.multimc.MultiMCComponents).");
        } else {
