...
import org.jackhuang.csl.download.cleanroom.CleanroomVersionList;
import org.jackhuang.csl.download.fabric.FabricAPIVersionList;
import org.jackhuang.csl.download.fabric.FabricVersionList;
import org.jackhuang.csl.download.forge.ForgeBMCLVersionList;
import org.jackhuang.csl.download.game.GameVersionList;
import org.jackhuang.csl.download.legacyfabric.LegacyFabricAPIVersionList;
import org.jackhuang.csl.download.legacyfabric.LegacyFabricVersionList;
import org.jackhuang.csl.download.liteloader.LiteLoaderBMCLVersionList;
import org.jackhuang.csl.download.neoforge.NeoForgeBMCLVersionList;
import org.jackhuang.csl.download.optifine.OptiFineBMCLVersionList;
import org.jackhuang.csl.download.quilt.QuiltAPIVersionList;
import org.jackhuang.csl.download.quilt.QuiltVersionList;
...
public final class BMCLAPIDownloadProvider implements DownloadProvider {
    ...
    public BMCLAPIDownloadProvider(String apiRoot) {
        ...
        this.replacement = List.of(
                ...
                pair("https://csl.glavo.site/metadata/cleanroom", "https://alist.8mi.tech/d/mirror/CSL-Metadata/Auto/cleanroom"),
                pair("https://csl.glavo.site/metadata/fmllibs", "https://alist.8mi.tech/d/mirror/CSL-Metadata/Auto/fmllibs"),
