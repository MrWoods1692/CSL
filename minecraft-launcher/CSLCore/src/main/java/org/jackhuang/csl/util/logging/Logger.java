 ...
 */
package org.jackhuang.csl.util.logging;
...
public final class Logger {
    ...
    static final String PACKAGE_PREFIX = "org.jackhuang.csl.";
    ...
    public void start(Path logFolder) {
        ...
        loggerThread.setName("CSL Logger Thread");
        loggerThread.start();

        Thread cleanerThread = new Thread(this::onExit);
        cleanerThread.setName("CSL Logger Shutdown Hook");
