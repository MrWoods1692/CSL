 ...
 */
package org.jackhuang.csl.util.platform.hardware;
...
public class HardwareDetector {
    private static final boolean USE_FAST_FETCH = "true".equalsIgnoreCase(System.getProperty("csl.hardware.fastfetch", "true"));
