 ...
 */
package org.jackhuang.csl.download.quilt;

import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import org.jackhuang.csl.download.DefaultDependencyManager;
import org.jackhuang.csl.download.LibraryAnalyzer;
import org.jackhuang.csl.download.UnsupportedInstallationException;
import org.jackhuang.csl.game.Arguments;
...
import static org.jackhuang.csl.download.UnsupportedInstallationException.FABRIC_NOT_COMPATIBLE_WITH_FORGE;
...
public final class QuiltInstallTask extends Task<GameInstancePatch> {
    ...
    public void execute() {
        ...
        dependencies.add(new org.jackhuang.csl.download.game.GameLibrariesTask(dependencyManager, manifest, true, getResult().getLibraries()));
    }
