...
import org.jackhuang.csl.modpack.ModpackManifest;
...
public final class MultiMCInstanceConfiguration implements ModpackManifest {
    ...
    MultiMCInstanceConfiguration(String defaultName, InputStream contentStream, MultiMCManifest mmcPack) throws IOException {
        ...
        // Maybe this will provide some problems (and it does, such as https://github.com/MrWoods1692/CSL/issues/2991), but this workaround works, doesn't it?
    ...
    /**
     * A workaround for <a href="https://github.com/MrWoods1692/CSL/issues/2991">...</a>
     */
