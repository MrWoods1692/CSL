...
public final class MultiMCInstancePatch {
    public static final Library BOOTSTRAP_LIBRARY = new Library(new Artifact("org.jackhuang.csl", "mmc-bootstrap", "1.0"));
    ...
    public static ResolvedInstance resolveArtifact(List<MultiMCInstancePatch> patches, GameInstanceID instanceId) {
        ...
        for (String trait : traits) {
            switch (trait) {
                ...
                case "texturepacks": // CSL hasn't support checking whether a game version supports texture packs.
...

        {
            ...
            jvmArguments.add(new StringArgument("-Dcsl.mmc.bootstrap=" + NetworkUtils.withQuery("csl:///bootstrap_profile_v1/", Map.of(
                    "main_class", mainClass,
                    "installer", MultiMCComponents.getInstallerProfile()
            ))));
            mainClass = "org.jackhuang.csl.CSLMultiMCBootstrap";
        }
