 ...
 */
package org.jackhuang.csl.addon.repository;
...
import org.jackhuang.csl.util.Immutable;
import org.jackhuang.csl.util.MurmurHash2;
...
import static org.jackhuang.csl.util.gson.JsonUtils.listTypeOf;
...
public final class CurseForgeRemoteAddonRepository implements RemoteAddonRepository {
    ...
    public static final String API_KEY = System.getProperty("csl.curseforge.apikey", JarUtils.getAttribute("csl.curseforge.apikey", ""));
    ...
    public SearchResult search(DownloadProvider downloadProvider, String gameVersion, @Nullable RemoteAddonRepository.Category category, int pageOffset, int pageSize, String searchFilter, SortType sortType, SortOrder sortOrder) throws IOException {
        ...
        try {
            ...
            // https://github.com/MrWoods1692/CSL/issues/1549
    ...
    public Optional<RemoteAddon.Version> getRemoteVersionByLocalFile(Path file) throws IOException {
        ...
        if (hash == 811513880) { // Workaround for https://github.com/MrWoods1692/CSL/issues/4597
