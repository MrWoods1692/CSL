import org.jackhuang.csl.gradle.ci.CheckUpdate
import org.jackhuang.csl.gradle.docs.UpdateDocuments
import org.jackhuang.csl.gradle.l10n.ParseLanguageSubtagRegistry
...
org.jackhuang.csl.gradle.javafx.JavaFXUtils.register(rootProject)
...
tasks.register<ParseLanguageSubtagRegistry>("parseLanguageSubtagRegistry") {
    ...
    sublanguagesFile.set(layout.projectDirectory.file("CSLCore/src/main/resources/assets/lang/sublanguages.csv"))
    defaultScriptFile.set(layout.projectDirectory.file("CSLCore/src/main/resources/assets/lang/default_script.csv"))
}
...
tasks.register<CheckUpdate>("checkUpdateDev") {
    uri.set("https://ci.huangyuhui.net/job/CSL-nightly")
}

tasks.register<CheckUpdate>("checkUpdateStable") {
    uri.set("https://ci.huangyuhui.net/job/CSL-stable")
}
