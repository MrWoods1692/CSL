...
public final class CSLMultiMCBootstrap {
    private CSLMultiMCBootstrap() {
    }

    public static void main(String[] args) throws Throwable {
        String profile = System.getProperty("csl.mmc.bootstrap");
        if (profile == null) {
            launchLegacy(args);
            return;
        }
    ...
    private static void launchLegacy(String[] args) throws Throwable {
        String mainClass = new String(Base64.getUrlDecoder().decode(System.getProperty("csl.mmc.bootstrap.main")), StandardCharsets.UTF_8);
        String installerInfo = new String(Base64.getUrlDecoder().decode(System.getProperty("csl.mmc.bootstrap.installer")), StandardCharsets.UTF_8);

        launch(installerInfo, mainClass, args);
    }

    private static void launch(String installerInfo, String mainClass, String[] args) throws Throwable {
        System.out.println("This version is installed by CSLCore's MultiMC combat layer.");
